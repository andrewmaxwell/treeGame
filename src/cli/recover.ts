...
const leaves = (g: Headless) => [...g.game.cells.values()].filter((c) => c.type === 'leaf').length

// From a single seed, the simplest possible play: keep a short trunk and fill leaves with
// the whole budget every growth season. If the economy is healthy this snowballs.
